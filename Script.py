...
𝙃𝙤𝙬 𝙏𝙤 𝙐𝙨𝙚
• 𝘛𝘺𝘱𝘦 /video or /mp4 𝘈𝘯𝘥 (https://youtu.be/HhjHYkPQ8F0)
• 𝘌𝘹𝘢𝘮𝘱𝘭𝘦:
<code>/mp4 https://youtu.be/HhjHYkPQ8F0</code>
<code>/video https://youtu.be/HhjHYkPQ8F0</code>"""
...
• 𝘌𝘹𝘢𝘮𝘱𝘭𝘦
<code>/ytthumb https://youtu.be/HhjHYkPQ8F0</code>"""
